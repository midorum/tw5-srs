/*\
title: test/strategy/grouping/taggedAny.js
module-type: library

Unit tests for the createSession service with a taggedAny strategy
...
describe("The createSession service", () => {
    ...
    describe("with taggedAny group strategy", () => {
        ...
        it("should create a new session"
            ...
            + " when direction is both", () => {
                ...
                const groupStrategy = "taggedAny";
                const groupListFilter = "[[" + group1 + "]][[" + group2 + "]]"; // two groups
                const groupFilter = undefined; // we do not need this paraneter
                ...
                while (expectedTiddlersCount-- > 0) {
                    ...
                    expect(messageHandler.commitAnswer(commitAnswerParams, options.widget, options.envt)).nothing();
                }
